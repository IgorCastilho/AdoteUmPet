...
<title> Adote um pet - Login</title>
...
<img align="center"  width="100px" height="100px" src="Imagens/pata.png"/>
		...
		<div id="menu">
			<ul>
				...
				<li  class="active"><a href="login.php" accesskey="2" title="">Login</a></li>
...
<tr>				
<td>Email:  
<input  type="text" name="email"   size="40" maxlenght="60" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$"</input> </td>
</tr>


<tr>
<td>Senha:
<input  type="password" name="senha"   size="40" maxlenght="15" </input></td>
</tr>
